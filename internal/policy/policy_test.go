...
func TestLoadRefusals(t *testing.T) {
	...
	tests := []struct {
		...
		{"unknown field", `"schema": 5`, `"schema": 5, "surprise": true`, wantUnknownField},
		{"schema absent", `"schema": 5,`, ``, "schema is absent"},
		{"schema newer", `"schema": 5`, schemaPlusOne(), "not the implemented schema"},
