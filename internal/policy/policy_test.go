...
func TestLoadRefusals(t *testing.T) {
	...
	tests := []struct {
		...
		{"unknown field", `"schema": 2`, `"schema": 2, "surprise": true`, wantUnknownField},
		{"schema absent", `"schema": 2,`, ``, "schema is absent"},
		{"schema newer", `"schema": 2`, `"schema": 3`, "not the implemented schema"},
